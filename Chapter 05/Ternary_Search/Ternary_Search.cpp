    ...
    int val)
{
    ...
    if(startIndex <= endIndex)
    {
        ...
        // If val is at the area the last third
        ...
        // between middleLeftIndex and middleRigthIndex
        // arr[middleLeftIndex + 1 ... middleRigthIndex - 1]
        else 
        {
            return TernarySearch(
                arr,
