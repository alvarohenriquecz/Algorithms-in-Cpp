// Project: Interpolation_Search.cpp
    ...
    int val)
{
    if(lowIndex <= highIndex)
    {
        ...
        // If the middle index's value is lower than ther searched value
        // then perform another Interpolation Search to the rigth sub array
...
int main()
{
    cout << "Intr polation Search" << endl;
